# Generated by Django 3.0.3 on 2020-02-20 20:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topic_comments', to='django_simple_forum.Topic')),
                ('votes', models.ManyToManyField(to='django_simple_forum.Vote')),
            ],
        ),
        migrations.CreateModel(
            name='Attachment',
